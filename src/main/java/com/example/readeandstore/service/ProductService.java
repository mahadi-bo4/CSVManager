package com.example.readeandstore.service;

import com.example.readeandstore.entity.Product;
import com.example.readeandstore.repo.ProductRepository;
        ...
        try(BufferedReader reader = new BufferedReader(new InputStreamReader(file.getInputStream()))){
            ...
            while((lines = reader.readLine()) != null){
                ...
                if(chunks.length == 4){
                    ...
                    product.setProductId(Long.parseLong(chunks[0].trim()));
